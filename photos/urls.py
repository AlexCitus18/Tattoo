...
urlpatterns = [
    path('', IndexRenderView.as_view(), name='index'),
    path('photos/', PhotographyByCategoryListView.as_view(), name='photos'),
    path('consultations/', ConsultationCreateView.as_view(), name='consultations'),
